...
export function HamperBuilder() {
  ...
  const handleSelectPlan = (plan: BoxPlan) => {
    ...
    showNotice(`Switched to ${plan.name} (${plan.slots} slots)`, 'info');
  };
  ...
  return (
    <section id="builder" className="scroll-mt-24 sm:scroll-mt-28 py-16 sm:py-20 bg-cream-100 relative overflow-hidden">
      ...
      {/* =========================================================================
          MOBILE FLOATING STICKY MINI-BAR (Always visible on mobile with z-50)
         ========================================================================= */}
      <div className="lg:hidden fixed bottom-0 left-0 right-0 z-50 bg-[#2A1820] backdrop-blur-md border-t-2 border-[#D8C7A0] py-2.5 px-4 flex items-center justify-between gap-3 shadow-[0_-10px_30px_rgba(0,0,0,0.5)]">
        <div 
